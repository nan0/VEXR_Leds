  ...
  <head>
    ...
    <script>
      ...
      window.addEventListener('load', (event) => {
        ...
        document.querySelector("#linear-animation").addEventListener('click', () => post("/animation/linear"));
        document.querySelector("#accordion-animation").addEventListener('click', () => post("/animation/accordion"));
        document.querySelector("#fixed-animation").addEventListener('click', () => post("/animation/fixed"));
        document.querySelector("#front-brightness").addEventListener('change', e => {
          const level = e.target.value;
          post('/brightness/front', level);
        ...
        get("/brightness/front", level => {
          document.querySelector("#front-brightness").value = +level;
          document.querySelector("#front-brightness-value").innerText = level;
        });
        get("/brightness/back", level => {
